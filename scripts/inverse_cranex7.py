...
#'''
px = -0.019*(((-sin(j1)*sin(j3) + cos(j1)*cos(j2)*cos(j3))*cos(j4) - sin(j2)*sin(j4)*cos(j1))*cos(j5) + (-sin(j1)*cos(j3) - sin(j3)*cos(j1)*cos(j2))*sin(j5))*sin(j6) + 0.019*(-(-sin(j1)*sin(j3) + cos(j1)*cos(j2)*cos(j3))*sin(j4) - sin(j2)*cos(j1)*cos(j4))*cos(j6) - 0.25*(-sin(j1)*sin(j3) + cos(j1)*cos(j2)*cos(j3))*sin(j4) - 0.25*sin(j2)*cos(j1)*cos(j4) - 0.25*sin(j2)*cos(j1)
py = -0.019*(((sin(j1)*cos(j2)*cos(j3) + sin(j3)*cos(j1))*cos(j4) - sin(j1)*sin(j2)*sin(j4))*cos(j5) + (-sin(j1)*sin(j3)*cos(j2) + cos(j1)*cos(j3))*sin(j5))*sin(j6) + 0.019*(-(sin(j1)*cos(j2)*cos(j3) + sin(j3)*cos(j1))*sin(j4) - sin(j1)*sin(j2)*cos(j4))*cos(j6) - 0.25*(sin(j1)*cos(j2)*cos(j3) + sin(j3)*cos(j1))*sin(j4) - 0.25*sin(j1)*sin(j2)*cos(j4) - 0.25*sin(j1)*sin(j2)
pz = -0.019*((sin(j2)*cos(j3)*cos(j4) + sin(j4)*cos(j2))*cos(j5) - sin(j2)*sin(j3)*sin(j5))*sin(j6) + 0.019*(-sin(j2)*sin(j4)*cos(j3) + cos(j2)*cos(j4))*cos(j6) - 0.25*sin(j2)*sin(j4)*cos(j3) + 0.25*cos(j2)*cos(j4) + 0.25*cos(j2) + 0.105
#'''
